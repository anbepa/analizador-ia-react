    ...
    return (
        <div className="space-y-5">
            <label
                ...
                onDrop={handleDrop}
                className={`group relative w-full cursor-pointer rounded-2xl border border-secondary-200/80 bg-secondary-50/60 p-6 flex flex-col items-center justify-center text-center transition-all duration-300 ease-out shadow-apple-md overflow-hidden ${
                    isDragging
                        ? 'border-primary/50 bg-primary/5 scale-[1.01] shadow-apple-lg'
                        : 'hover:border-primary/40 hover:bg-white/70'
                }`}
            >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-white/40 via-secondary-50/60 to-primary/5" />
